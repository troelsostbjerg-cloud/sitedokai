...
## Karaktererne
| Figur | Kendetegn | ADHD-profil | Running gag |
|---|---|---|---|
...
## Faste elementer (formlen, ~2 min)
1. **Cold open (0–7 s):** det absurde resultat først ("Kaffen står i køleskabet. *Igen.*").
2. **Titelkort:** "Tændstikfamilien – Afsnit N: …"
3. **"X minutter tidligere …"** med uret, der spoles tilbage.
4. **To historier:** én om Bo, én om Lise.
5. **ADHD-FAKTA-kort** efter hver historie: kort, sandt og med en tør pointe til sidst.
6. **Aften i sofaen:** "Det er kaos. Men det er *vores* kaos." (Den varme afslutning, som gør serien til noget, man holder af, ikke bare griner af.)
7. **Slutkort:** skiltet "Dage uden ufærdigt projekt: 0", "Abonnér. Hvis du kan *huske* det." og teaser til næste afsnit.

## Tone
- Grin **med**, aldrig **af**. Figurerne er kompetente og elskede, bare med en anden hjerne.
- Fakta skal være sande og ikke-kliniske. Ingen diagnoser, ingen "tips til at blive normal".
- Én accentfarve (koral) = ADHD-gnisten: idéer, hyperfokus, fakta og tællere.

## Idéer til afsnit
1. ✅ **Kaffen er i køleskabet**: åbne låger og hyperfokus i haven.
2. **Hvor er bilnøglerne?**: familien kommer 12 minutter for sent. Fakta: tidsblindhed.
3. **Bare lige et hurtigt svar**: Bo åbner mailen og står op 3 timer senere. Fakta: "task switching".
4. **Den gode idé kl. 23.40**: Lise køber domæne, logo og 40 kg ler. Fakta: dopamin og nyhedens tiltrækning.
5. **Opvasken**: den umulige opgave (der tager 7 minutter). Fakta: "wall of awful".
6. **Fødselsdagen**: gaven er købt i marts, gemt "et sikkert sted" og aldrig fundet. Fakta: ude af syne = ude af sind, del 2.
7. **Body doubling**: begge rydder op, men kun når den anden er i rummet.
8. **Afbrydelser**: Lise fortæller en historie med 7 sidespor og kommer frem til pointen. Fakta: associativ tænkning (en styrke).
9. **Superkraften**: brand i køkkenet, og alle andre går i panik. Bo og Lise er iskolde og løser det. Fakta: ADHD-hjerner kan være gode i kriser.
10. **Julespecial**: 4 juletræer, 0 gaver pakket ind.

## Distribution (hvis målet er mange følgere)
- **YouTube (16:9, ~2 min)** er "hovedafsnittet".
