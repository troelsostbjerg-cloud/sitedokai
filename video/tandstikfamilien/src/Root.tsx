...
export const RemotionRoot: React.FC = () => (
  <>
    <Composition id="Episode1-EN" component={Episode} defaultProps={{ lang: "en" as const }} durationInFrames={totalFrames} fps={FPS} width={W} height={H} />
    <Composition id="Episode1-DA" component={Episode} defaultProps={{ lang: "da" as const }} durationInFrames={totalFrames} fps={FPS} width={W} height={H} />
    {SCENES.map((s) => (
      <Composition
        key={s.id}
        id={`Scene-${s.id}`}
        component={() => <Wrap lang="en"><s.C /></Wrap>}
